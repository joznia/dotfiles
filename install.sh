...
$inst "xmobar arc-gtk-theme papirus-icon-theme firefox irssi alacritty xterm exa neovim vim rofi dmenu git wget curl ranger lynx lxappearance picom nitrogen"
